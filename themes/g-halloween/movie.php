        ...
        <div class="main-content main-detail">
            <div id="bread">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><a href="<?php echo $row['id'];?>"><?php echo $title;?> (<?php echo $year;?>)</a></li>
                </ol>
            </div>
...
document.getElementById('iframe').src.replace('autoplay=0','autoplay=1');">
                <div class="player-container">
                    ...
                    <a href="#login" style="visibility: visible;" id="playnow" class="play inline cboxElement" data-toggle="modal" data-target="#pop-login" >
                         ...
                         <span class="shadow"></span><img class="impl overlay" src="<?php echo $images;?>" alt="<?php echo $title;?>">
                      
                    </a>
                     
                </div>
                 
               <div id="caption">  <div class="caption-wraper"><span class="jtitle"><?php echo $title;?></span></div></div>
                <div id="controls">
...
<?php echo $genre;?> </p> 
 ...
 <p> <strong><a href="#" >Production Company:</a></strong>
<?php echo $companies;?>  </p>
  <p><strong><a href="#" >Release:</a></strong> <meta itemprop="datePublished" content="<?php echo $release_date;?>"><?php echo date('M d, Y', strtotime($release_date));?></p>
 </div>
                            
            <div class="mvici-right">
<p><strong><a href="#" >Production Countries:</a></strong> <?php echo $country;?></p>
<p><strong><a href="#" >Quality:</a></strong> <span class="quality">HD</span></p>
<p><strong><a href="#" >Rating:</a></strong> <?php echo $get_rating;?></p>
<p><strong><a href="#" >Casts:</a></strong> <?php echo $cast;?></p>
...
<div id="commentfb">
	...
	<div class="jm-item-wrapper">
		...
		<div class="jm-item-title"><?php echo $similar['title'];?></div>
	</div>
</div>
<?php 
                                endforeach;
